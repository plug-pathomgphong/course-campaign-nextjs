  ...
  renderCards() {
    ...
    const items = [
      ...
      },
      {
        ...
        description:
          "Number of people who hve alreary donated to this campaign.",
        style: { overflowWrap: "break-word" },
      },
      {
        header: web3.utils.fromWei(balance, "ether"),
        meta: "Camapign Balance (ether)",
        description: "is how much money this campaign has left to spend.",
        style: { overflowWrap: "break-word" },
      },
    ];
    ...
    return (
      <Layout>
        ...
        <Grid>
          ...
          <Grid.Row>
            <Grid.Column>
                <Link route={`/campiagns/${this.props.address}/requests`}>
                    <a>
